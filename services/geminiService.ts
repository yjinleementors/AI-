...
const experienceItemSchema = {
  ...
  required: ["type", "activityName", "host", "period", "field", "link", "competency", "portfolioTip"]
};
...
const createPrompt = (userInput: UserInput): string => {
  return `
    ...
    **[큐레이션 구조]**
    1. 맞춤형 경험: 사용자의 성향과 강점에 최적화된 활동
    2. 보완형 경험: 성향의 약점을 보완할 수 있는 도전적인 활동
    3. 확장형 경험: 전공 외 시야를 넓혀주는 트렌디한 활동
